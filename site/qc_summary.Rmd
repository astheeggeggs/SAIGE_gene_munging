...
# dt_2 <- fread('../site_tables/03_variant_count_summary.tsv', header=FALSE)
...
dt <- cbind(
  ...
  fread("../site_tables/sample_detailed_summary_table.tsv")
}
...
if (file.exists(PLOTS)) {
  ...
  fread("../site_tables/sample_summary_table.tsv")
}
