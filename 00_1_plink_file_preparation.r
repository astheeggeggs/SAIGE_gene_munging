...
eur_fam <- "/well/lindgren/UKBIOBANK/flassen/projects/KO/wes_ko_ukbb/data/saige/grm/input/211026_long_ukb_wes_200k_sparse_autosomes.fam"
...
fwrite(fread(eur_fam) %>% mutate(V1=V2), file = out_sparse_fam, sep='\t', col.names=FALSE)