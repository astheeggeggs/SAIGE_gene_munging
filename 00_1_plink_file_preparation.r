...
out_sparse_GRM_samples <- "/well/lindgren/UKBIOBANK/dpalmer/ukb_genotype_plink/ukb_eur_chr1_22_sparse_markers.tsv"
out_sparse_fam <- "/well/lindgren/UKBIOBANK/dpalmer/ukb_genotype_plink/ukb_eur_chr1_22_sparse_markers.fam"
