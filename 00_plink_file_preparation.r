...
eur_fam <- "/well/lindgren/UKBIOBANK/flassen/projects/KO/wes_ko_ukbb/data/saige/grm/input/eur_ukbb/ukb_eur_wes_sparse_markers_autosomes.fam"
...
fwrite(fread(eur_fam) %>% mutate(V1=V2) %>% mutate(V6=-9), file=out, sep=' ', col.names=FALSE)
